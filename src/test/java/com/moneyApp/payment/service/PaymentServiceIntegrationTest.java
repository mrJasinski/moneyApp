...
public class PaymentServiceIntegrationTest
{
    ...
    @Autowired
    private PaymentDateRepository paymentDateRepo;
...
//        when
        var result1 = toTest.createPaymentByUserEmail(dto1, "foo");
        var result2 = toTest.createPaymentByUserEmail(dto2, "foo");
...
//        when
        var result = catchThrowable(() -> toTest.createPaymentByUserEmail(dto, "foo"));
...
//        then
        ...
        toTest.generatePaymentDates(p5);
...
//        when
        var result = toTest.createPaymentDateByDate(payment.getStartDate(), payment);
